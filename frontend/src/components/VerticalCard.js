...
const VerticalCard = ({loading, data=[]}) => {
    const loadingList = new Array(150).fill(null)
  ...
  return (
    <div className=' grid grid-cols-[repeat(auto-fit,minmax(250px,300px))] justify-center md:justify-between md:gap-4 overflow-x-scroll scrollbar-none transition-all'>

                {
                    loading?(
                        loadingList?.map((product, index) => {
                            return (
                                <div className='w-full min-w-[280px] md:min-w-[300px] max-w-[280px] md:max-w-[300px] bg-white rounded-sm 
                                shadow-md '>
